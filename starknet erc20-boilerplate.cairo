...
@constructor
func constructor{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(ohita : felt, oht : felt, owner: felt, 100000000 : felt) {
 ERC20.initializer(ohita, oht, 18); 
ERC20._mint(owner, Uint256(supply, 100000000));
return ();
}
...
@view
func name{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (ohita: felt) {
return ERC20.ohita();
}

@view
func symbol{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (oht: felt) {
return ERC20.oht();
}
